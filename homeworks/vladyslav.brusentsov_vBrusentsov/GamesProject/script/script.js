...
const CALCULATE_OPERATION = document.getElementById('calculate-opertaion');
...
CALCULATE_BUTTON_ELEMENT.addEventListener('click', () => {
    ...
    CALCULATE_OPERATION.innerText = `${firstValue} ${operation} ${secondValue} = ${window.calculate(firstValue, secondValue, operation)}`;
});
