...
cardClone.querySelector('[data-card-genre]').textContent = `Genre: ${game.genre}`;
cardClone.querySelector('[data-card-platform]').textContent = `Platform: ${game.platform}`;
cardClone.querySelector('[data-card-publisher]').textContent = `Publisher: ${game.publisher}`;
cardClone.querySelector('[data-card-developer]').textContent = `Developer: ${game.developer}`;
cardClone.querySelector('[data-card-release-date]').textContent = `Release date: ${game.releaseDate}`;
...
const container = document.querySelector(`[data-container="${cardsContainer}"]`);
